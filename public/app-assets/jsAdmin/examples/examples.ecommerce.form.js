...
(function($) {
	 ...
	 *
	 */
	var initializeDropzone = function(id) {		
		$('#dropzone-form-image').dropzone({
			url: '/admin/products/images/'+id,
			addRemoveLinks: true,
			init: function() {
	...
	$(document).ready(function(){
		...
		if( $('#dropzone-form-image').get(0) ) {
			console.log( "Load" , $('#dropzone-form-image').data('ref') ) ;
			initializeDropzone($('#dropzone-form-image').data('ref'));
		}
	});
