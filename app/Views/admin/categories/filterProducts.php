					...
					<div class="row row-gutter-sm mb-6">
						...
						<div class="col-lg col-xl">
							...
							<?php 
									...
									<div class="col-sm-6 col-xl-4">
										<div class="card card-modern card-modern-alt-padding">
											<div class="card-body bg-light">
												...
												<a class='btn btn-default' href="<?php echo base_url('admin/products/edit/'.$product['product_id'])?>"><i class="bx bx-pencil"></i> </a>
												<a class='btn btn-default' href="<?php echo base_url('admin/products/delete/'.$product['product_id'])?>"><i class="bx bx-trash"></i></a>
											</div>
										</div>
									</div>
								<?php
								...
								?>
								<h4>Oups aucun produit pour cette catégorie ..</h4>
								<?php
								}
							?>
							<!-- fin boucle-->
