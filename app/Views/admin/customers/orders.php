					...
					<div class="row">
						<div class="col">
							...
							<div class="card card-modern">
								<div class="card-body">
								<!--
								pagination du template a partir d'un id
								...
								<table class="table table-ecommerce-simple table-striped mb-0"  style="min-width: 550px;">
											<thead>
												<tr>
													...
													<th width="38%">Prix Total</th>
													<th width="38%">Payement</th>
													<th width="38%">Etat</th>
											...
											<tbody>
												<?php 
												if(isset($listOrders) && !empty($listOrders))
												{
                                                ...
                                                <tr>
													...
													<td class='profile-info profile-info-no-role'><a href="<?php echo base_url('admin/customers/details/'.$order['order_id'].'/'.$user['user_id']) ?>"><strong><?php echo $order['order_id'];?></strong></a></td>
													<td><a href="#"><strong><?php echo $order['date'];?></strong></a></td>
													<td><a href="#"><strong><?php echo $user['email'];?></strong></a></td>
													<td><a href="#"><strong><?php echo $order['total'];?> €</strong></a></td>
													<td><a href="#"><strong>...</strong></a></td>
													<td><a href="#"><strong><?php echo $order['etat'];?></strong></a></td>
												...
												<tr><h4> Aucunes commandes trouvées </h4></tr>
												<?php
												}
												?>
