...
<html class="modern fixed has-top-menu has-left-sidebar-half" data-style-switcher-options="{'changeLogo': false}">
	<head>
		...
		<title>Product Name | Porto Admin - Responsive HTML5 Template</title>
...
<link href="https://fonts.googleapis.com/css?family=Poppins:100,300,400,600,700,800,900" rel="stylesheet" type="text/css">
		...
		<link rel="stylesheet" href="<?php  echo base_url() ?>/app-assets/vendorAdmin/select2/css/select2.css" />
		<link rel="stylesheet" href="<?php  echo base_url() ?>/app-assets/vendorAdmin/select2-bootstrap-theme/select2-bootstrap.min.css" />
		<link rel="stylesheet" href="<?php  echo base_url() ?>/app-assets/vendorAdmin/dropzone/basic.css" />
		<link rel="stylesheet" href="<?php  echo base_url() ?>/app-assets/vendorAdmin/dropzone/dropzone.css" />
		<link rel="stylesheet" href="<?php  echo base_url() ?>/app-assets/vendorAdmin/bootstrap-markdown/css/bootstrap-markdown.min.css" />
		<link rel="stylesheet" href="<?php  echo base_url() ?>/app-assets/vendorAdmin/pnotify/pnotify.custom.css" />
